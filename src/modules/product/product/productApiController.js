...
const getAllProducts = async (req, res) => {
    try {
        ...
        // Attributes
        const attributes = ['id', 'name', 'sku', 'description', 'is_active', 'max_retail_price', 'is_on_sale', 'special_sale_price']
        // Service Calling
        const { status, data, error } = await productUtility.getAllProducts(page, limit, attributes);
...
const getProductById = async (req, res) => {
    try {
        ...
        const { status, data, error } = await productUtility.getProductById(id, attributes, zip_code, userId);
        if (_.isEmpty(data)) {
